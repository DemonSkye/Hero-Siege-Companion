...
- Collapsible Run Pace charts with individually hideable XP, gold, kills, and observed-item lanes, up to four removable exact-item lanes, and a shared exact-value inspector for live and saved runs.
